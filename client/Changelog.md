...
- **Huge CSS Improvements**
  ...
  - _[CSS Modules](../client/docs/css/css-modules.md)_: Finally, truly modular, reusable
    styles!
  ...
  - _Standards rock:_ Nothing beats consistent styling so we beefed up the
    quality checks with **[stylelint](../client/docs/css/stylelint.md)** to help ensure
